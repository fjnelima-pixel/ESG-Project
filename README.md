...
This project demonstrates how a commercial bank can apply Environmental and Social Risk Management (ESRM) principles to assess, monitor and manage sustainability risks within a loan portfolio.

The analysis simulates Environmental & Social Due Diligence (ESDD), ESG risk scoring, ESAP tracking and green finance opportunity identification, using a multi-country loan portfolio aligned to banking sustainability and compliance workflows.
...
Clean summary tables suitable for dashboards, management packs or DFI reporting
